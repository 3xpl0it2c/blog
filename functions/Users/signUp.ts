/*
Upon recieving a POST to the /user/signup path
This function should:

1.Recieve credentials required for sign up (See interfaces/User)
...
3.Use the repository to send a verfication email
4.Use the repository to store the credentials, but set them to unverfied.
